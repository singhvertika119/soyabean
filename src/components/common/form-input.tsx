              ...
              <FormControl>
                <div className="relative">
                  <Input
                    ...
                    disabled={disabled}
                    className={`${className} placeholder:text-gray-light bg-kawaii-input border-kawaii-pink !focus-visible:ring-2 !focus-visible:ring-kawaii-pink !focus-visible:ring-opacity-50 !focus-visible:border-kawaii-pink h-12 w-full rounded-xl tracking-wider transition-all duration-200 focus-visible:outline-none`}
                  />
